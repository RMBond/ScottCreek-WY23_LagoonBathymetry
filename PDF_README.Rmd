...
author: "Rosealea Bond (lea.bond@noaa.gov)"
date: "2023-09-29`"
output:
  pdf_document:
    toc: true
...
* Sediment within the survey area was a mixtrure of mudstone cobble, gravel, and sand. (More coarse then previous years).
